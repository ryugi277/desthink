...
info = {
    'title' : LazyString(lambda: 'Sentiment Analysis - Rina Yulius, Fajri Amirul, Banu Failasuf'),
    'version' : LazyString(lambda : '1.0.0'),
    'description': LazyString(lambda : 'You can use this Flask API to upload or type students and instructors feedback to analize the sentiment data of design thinking implementation in vocational institution PjBL through reflective-based learning'),
},
...
def home():
    welcome_msg = {
        "version": "1.0.0",
        "message": "Welcome to Flask API of Sentiment Analysis of Design Thinking Implementation",
        "author": "Rina Yulius, Fajri Amirul & Banu Failasuf"
    }
